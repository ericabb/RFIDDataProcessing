function Data = ImportDataShengliSAW(fileToRead,Flag_Single)
SID_Digits = 4; % Define the number of EPC
newData = [];
[status,sheets] = xlsfinfo(fileToRead);

for i = 1:length(sheets)
    newData = [newData;xlsread(fileToRead,Sheet{i})];
end
...
Data = [Time_New EPC AntNum RSSI Temperature];
end