...
% =========================================================================
function Data = LoadingDataIntelliSAW(PathName, SaveFileName)
%% Arguments check
...
FileName = dir(strcat(PathName,'\*.csv'));
...
if NumFiles <= 0
    ...
    %     Data = ImportFileFN([PathName FileName{1}]);
        ...
        for i = 2:length(FileName)
            Data = [Data; ImportDataIntelliSAW([PathName '\' FileName(i).name],0)];
