...
% =========================================================================
function Data = LoadingDataRTEC(PathName, SaveFileName)
%% Arguments check
...
if NumFiles <= 0
    ...
    %     Data = ImportFileFN([PathName FileName{1}]);
        ...
        for i = 2:length(FileName)
            Data = [Data; ImportDataRTEC([PathName '\' FileName(i).name],0)];
