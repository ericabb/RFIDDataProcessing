...
% =========================================================================
function Data = LoadingDataShengliSAW(PathName, SaveFileName)
%% Arguments check
...
FileName = dir(strcat(PathName,'\*.xls'));
...
if NumFiles <= 0
    ...
    %     Data = ImportFileFN([PathName FileName{1}]);
        ...
        for i = 2:length(FileName)
            Data = [Data; ImportDataShengliSAW([PathName '\' FileName(i).name],0)];
