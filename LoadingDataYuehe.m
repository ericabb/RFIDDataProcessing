...
% =========================================================================
function Data = LoadingDataYuehe(PathName, SaveFileName)
%% Arguments check
...
if NumFiles <= 0
    ...
    %     Data = ImportFileFN([PathName FileName{1}]);
        ...
        for i = 2:length(FileName)
            Data = [Data; ImportDataYuehe([PathName '\' FileName(i).name],0)];
